                ...
                <Row className="justify-content-center mt-4">
                    <Col xs={12} md={8}>
                        <div className="text-center">
                            ...
                            <p className="text-muted">En Training Date, nuestra misión es promover un estilo de vida saludable y activo al facilitar la conexión entre entrenadores cualificados y usuarios interesados en mejorar su bienestar físico y mental. Nos esforzamos por crear una comunidad inclusiva y motivadora que inspire a nuestros usuarios a alcanzar sus objetivos de fitness y bienestar.</p>
                        </div>
                    </Col>
                </Row>
