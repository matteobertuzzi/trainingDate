                    ...
                    <Card>
                        <Card.Body>
                            ...
                            {userInTrainerClass.specialization && (
                                <div>
                                    <Card.Text><strong>Espacializacion:</strong>{userInTrainerClass.specialization.name}</Card.Text>
                                    <Card.Text><strong>Descripcion especializacion:</strong>{userInTrainerClass.specialization.description}</Card.Text>
                                </div>
                            )}
                        </Card.Body>
                    </Card>
