...
const TrainerProfile = () => {
    ...
    useEffect(() => {
        async function fetchTrainer() {
            ...
            const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..d4g8-iiedyw59c5dO-Sw9S37Z3nRAekoDQhqEpqtIrc'
            if (!token) {
